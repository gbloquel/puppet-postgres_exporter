  ...
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      context 'postgres_exporter class without any parameters' do
        ...
        it do
          is_expected.to contain_archive('/tmp/postgres_exporter-0.10.1.linux-amd64.tar.gz')
            .with(
              'source'  => 'https://github.com/prometheus-community/postgres_exporter/releases/download/v0.10.1/postgres_exporter-0.10.1.linux-amd64.tar.gz',
              'creates' => '/opt/postgres_exporter-0.10.1.linux-amd64/postgres_exporter',
            )
        end
        it do
      ...
      context 'postgres_exporter class with parameters' do
        ...
        it do
          is_expected.to contain_archive('/tmp/postgres_exporter-0.7.0.linux-amd64.tar.gz')
            .with(
              'source'  => 'https://github.com/prometheus-community/postgres_exporter/releases/download/v0.7.0/postgres_exporter-0.7.0.linux-amd64.tar.gz',
              'creates' => '/opt/postgres_exporter-0.7.0.linux-amd64/postgres_exporter',
            )
        end
      end
    end
